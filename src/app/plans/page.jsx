    ...
    <div className="w-full min-h-screen bg-zinc-950 text-zinc-50 py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
          ...
          >
            {activePlans.map((plan, idx) => (
              <motion.div
                ...
                className={`relative bg-zinc-900 border rounded-2xl p-6 shadow-xl flex flex-col justify-between min-h-[480px] transition-colors duration-300 ${
                  plan.popular
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
          className="max-w-3xl mx-auto border-t border-zinc-800 pt-16"
        >
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full flex items-center justify-between text-left p-4 gap-4 text-zinc-200 hover:text-white transition-colors"
                  >
                    ...
                    >
                      <ChevronDown
                        className={`w-4 h-4 ${
                          isOpen ? "text-blue-400" : "text-zinc-500"
                        }`}
                      />
                    </motion.div>
                  </button>

                  {/* Framer Motion Collapsible Body */}
