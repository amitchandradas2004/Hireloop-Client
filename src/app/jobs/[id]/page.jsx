...
const Page = async ({ params }) => {
  ...
  return (
    <main className="w-full min-h-screen bg-zinc-950 text-zinc-100 p-6 md:p-12 lg:p-16">
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10 items-start py-10">
        ...
        <aside className="bg-zinc-900 border border-zinc-800/80 rounded-[32px] p-6 lg:sticky lg:top-8 space-y-6 shadow-xl">
          ...
          <Link
            href={`/jobs/${id}/apply`}
            className="w-full bg-purple-600 hover:bg-purple-700 text-white font-medium py-4 rounded-xl shadow-lg transition-colors flex items-center justify-center gap-2"
          >
            Apply For This Job
          </Link>
        </aside>
