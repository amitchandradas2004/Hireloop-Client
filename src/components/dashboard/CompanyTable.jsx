...
const CompanyTable = ({ companies }) => {
  ...
  return (
    <motion.div 
      ...
      className="w-full bg-[#121214] text-neutral-200 p-6 rounded-lg"
    >
              ...
              {companies.map((company, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Table.Cell className="py-4 align-middle">
                      <motion.div {...cellAnimation}>
                        <span className="px-3 py-1 bg-neutral-800/60 text-neutral-400 rounded-full text-xs capitalize inline-block">
                          {company.industry}
                        </span>
                      </motion.div>
                    </Table.Cell>
